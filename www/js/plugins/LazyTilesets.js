...
*
  /*:ja
  * @plugindesc タイルセットとその全データの
  * エクスポート/インポート/コピーを可能にします。
  * @author Shaz
  *
  ...
  * Tileset Note:
  *   <lzexport: filename>     # 
  * 	img/tilesets/filename.MVTilesetに設定をエクスポートします。
  *   <lzimport: filename>     # 
  * 	img/tilesets/filename.MVTilesetからファイルをインポートします。
  *   <lzcopy: ID>             # 
  * 	タイルセットから設定をコピーします。
  *
  *   <lzimport: filename A1 A2 B C>
  *   <lzcopy: ID A1 A2 B C>   # 
  * 	A1, A2, B, Cのインポート/コピーを行います。
  *
  *   <lzimport: filename B:D C:E>
  *   <lzcopy: ID B:D C:E>     # 
  * 	B, Cのインポート/コピーを行い、D, Eに置換します。
  *
  * 変更の反映を失わないために、使用後はコマンドを消去してください。
  * このプラグインはデバッグモードのみで動作します。
  */
