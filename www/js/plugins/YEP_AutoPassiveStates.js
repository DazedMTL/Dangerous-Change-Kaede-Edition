...
/*:ja
* @plugindesc アクター、敵、スキル、装備のステートをパッシブにできます
*
* @help
* ============================================================================
* Introduction
...
* ============================================================================
*
* アクター、クラス、スキル、武器、防具、敵のノートタグ:
*   <Passive State: x>
*   <Passive State: x, x, x>
* アクターや敵に、常に x という状態が付与されます。Notetagを
* 武器や防具内のNoteboxに配置すれば、その持ち主に対して有効になります。
*
*   <Passive State: x to y>
* アクターや敵に、x から y までのステートを付与します。Notetagを
* 武器や防具内のNoteboxに配置すれば、その持ち主に対して有効になります
*   
*/
